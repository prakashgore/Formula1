...
target_col = re.sub('[^A-Za-z0-9_]+', '_', "IS_WINNER")
...
mlflow.set_experiment("f1_race_winner_prediction_model-AutoMLExperiment")
...
settings = {
    ...
    "force_cancel": True, 
    "seed": 41 , # Random seed 
    "mlflow_exp_name": "f1_race_winner_prediction_model-AutoMLExperiment",  # MLflow experiment name
...
with mlflow.start_run(run_name="f1_race_winner_prediction_model") as run:
    automl.fit(
        X_train=X_train, 
...
registered_model = mlflow.register_model(model_uri=model_path, name="f1_race_winner_prediction_model")
...
model_name = "f1_race_winner_prediction_model"
...
saved_name = "Tables/gold_ml_features_predictions".replace(".", "_")
